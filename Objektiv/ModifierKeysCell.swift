//
//  ModifierKeysCell.swift
//  Objektiv
//
//  Created by Dannel Albert on 12/30/17.
//  Copyright © 2017 nth loop. All rights reserved.
//

import AppKit

class ModifierKeysCell: NSSegmentedCell {
    override var objectValue: Any? {
        set {
            guard let newValue = newValue as? NSEvent.ModifierFlags else {
                return
            }
